...
| 4 | **Las cartas se dibujan como SVG generado por código**, no como imágenes. Baraja de diseño propio: geometría + tipografía + color. | Cero riesgo de propiedad intelectual, cero presupuesto de ilustración, cero pipeline de assets, escala perfecta en tele y móvil, y da identidad propia. **Revocada en parte el 4-8-2026 por decisión de Unai — ver `02-PAQUETES.md` P30:** Pocha y Mus se pintan con imágenes de baraja española en `apps/web/public/cards/`; Chinchón sigue entero en SVG. El motivo de la decisión original que sigue vivo es el de propiedad intelectual: esas imágenes vienen de un tercero y llevan marca de agua, así que **antes de publicar hay que sustituirlas por arte propio o con licencia**. |
