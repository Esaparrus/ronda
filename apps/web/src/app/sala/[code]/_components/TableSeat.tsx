...
function SeatStatsLine({ handCount, score }: SeatStats) {
  return (
    <span
      ...
      className="whitespace-nowrap font-mono text-[11px] leading-none text-humo"
    >
      <strong className="font-semibold text-hueso">{handCount}</strong> cartas
