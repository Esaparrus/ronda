        ...
        {CARD_STYLE_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`interactive-surface flex min-h-52 flex-col items-center gap-2 p-3 text-center transition-colors ${
                isSelected
            ...
            >
              ...
              <span className={`text-12 font-semibold ${isSelected ? 'text-oro' : 'text-humo'}`}>
